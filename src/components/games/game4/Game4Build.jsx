...
function Game4Build() {
  ...
  const handleComplete = () => {
    if (questions.length > 0) {
      navigate('/game/4/gameplay', { state: { questions } })
    }
  }
  ...
  const handleSaveDraft = async () => {
    try {
      ...
      const existingDrafts = await localforage.getItem('game4_drafts') || []
      ...
      await localforage.setItem('game4_drafts', updatedDrafts)
        ...
        <div className="question-input-section">
          ...
          <div className="question-input-form">
            ...
            <div className="input-instructions">
              <p>* 1문제 당 최소 2글자, 최대 8글자 입력 가능합니다.</p>
              <p>* 최대 16문제 입력 가능합니다.</p>
